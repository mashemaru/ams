<div class="card-header" id="headingFacultyLeadership" data-toggle="collapse" data-target="#collapseFacultyLeadership" aria-expanded="false" aria-controls="collapseFacultyLeadership">
    <div class="row">
        <div class="col">
            <h5 class="mb-0">LEADERSHIP IN PROFESSIONAL ORGANIZATIONS</h5>
        </div>
...
<div id="collapseFacultyLeadership" class="collapse" aria-labelledby="headingFacultyLeadership" data-parent="#accordionExample3">
    <div class="col text-right pt-4 mb-4">
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#FacultyLeadershipModal"
            style="float:right">
    ...
    <div class="card-body px-0">
        <div class="table-responsive">
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                @foreach($faculty->faculty_leadership as $data)
                <tr>
                    <td>{{ $data->role }}</td>
...
<!-- Modal -->
<div class="modal fade" id="FacultyLeadershipModal" tabindex="-1" role="dialog" aria-labelledby="FacultyLeadershipModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bg-secondary">
            <div class="modal-header">
                <h5 class="modal-title" id="FacultyLeadershipModalLabel">Add Leadership</h5>
            ...
            <form method="post" action="{{ route('faculty.store', $faculty->id) }}" autocomplete="off">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="leadership" class="btn btn-primary">Add</button>
                </div>
            </form>
        </div>
    </div>
