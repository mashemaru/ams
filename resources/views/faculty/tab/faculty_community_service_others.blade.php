<div class="card-header" id="headingFacultyCommunityServiceOthers" data-toggle="collapse" data-target="#collapseFacultyCommunityServiceOthers" aria-expanded="false" aria-controls="collapseFacultyCommunityServiceOthers">
    <div class="row">
        <div class="col">
            <h5 class="mb-0">COMMUNITY SERVICE WITH OTHERS (since 2005)</h5>
        </div>
...
<div id="collapseFacultyCommunityServiceOthers" class="collapse" aria-labelledby="headingFacultyCommunityServiceOthers" data-parent="#accordionExample4">
    <div class="col text-right pt-4 mb-4">
        <!-- Button trigger modal -->
        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#FacultyCommunityServiceOthersModal"
            style="float:right">
    ...
    <div class="card-body px-0">
        <div class="table-responsive">
            <table class="table align-items-center table-flush">
                ...
                <tbody>
                @foreach($faculty->faculty_community_service_others as $data)
                <tr>
...
<!-- Modal -->
<div class="modal fade" id="FacultyCommunityServiceOthersModal" tabindex="-1" role="dialog" aria-labelledby="FacultyCommunityServiceOthersModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content bg-secondary">
            <div class="modal-header">
                <h5 class="modal-title" id="FacultyCommunityServiceOthersModalLabel">Add Community Service</h5>
            ...
            <form method="post" action="{{ route('faculty.store', $faculty->id) }}" autocomplete="off">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group{{ $errors->has('other_organization') ? ' has-danger' : '' }} mb-3">
                        <label class="form-control-label" for="input-other_organization">{{ __('Organization') }}</label>
                        <input type="text" name="other_organization" id="input-other_organization" class="form-control form-control-alternative{{ $errors->has('other_organization') ? ' is-invalid' : '' }}" placeholder="{{ __('Organization') }}" value="{{ old('other_organization') }}">
                        @if ($errors->has('other_organization'))
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $errors->first('other_organization') }}</strong>
                            </span>
                        @endif
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="community_service_others" class="btn btn-primary">Add</button>
                </div>
            </form>
        </div>
    </div>
